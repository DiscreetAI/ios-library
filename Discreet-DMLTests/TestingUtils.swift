...
public var testWebSocketURL = URL(string: "ws://localhost:8999")!
...
public var trainMessage = try! makeDictionaryString(keys: ["session_id", "round", "action"], values: [testSession, testRound, trainName])
