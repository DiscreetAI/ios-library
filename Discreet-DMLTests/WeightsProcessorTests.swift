...
class WeightsProcessorTests: XCTestCase {
    ...
    func testSimpleGradients() {
        ...
        let calculatedGradients: [[Double]] = weightsProcessor.calculateGradients(oldModelPath: oldSimpleWeightsPath, newModelPath: newSimpleWeightsPath, learningRate: 0.01)
    ...
    func testComplexGradients() {
        ...
        let calculatedGradients: [[Double]] = weightsProcessor.calculateGradients(oldModelPath: oldComplexWeightsPath, newModelPath: newComplexWeightsPath, learningRate: 0.01)
