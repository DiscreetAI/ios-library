...
class ImageDataset {
    ...
    public var examples: [(String, String)] = []   // (filename, label)
    ...
    public func imagePath(for label: String, filename: String) -> String {
        "\(split.folderName)/\(label)/\(filename)"
    }
...
extension ImageDataset {
    ...
    func addImage(_ image: UIImage, for label: String, filename: String) {
